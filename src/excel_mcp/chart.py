    ...
    try:
        ...
        try:
            ...
            if style.get("show_data_labels", False):
                ...
                dlo = style.get("data_label_options", {}) if isinstance(style.get("data_label_options", {}),
                                                                        dict) else {}
        ...
        try:
            ...
            if not target_cell or not any(c.isalpha() for c in target_cell) or not any(
                    c.isdigit() for c in target_cell):
